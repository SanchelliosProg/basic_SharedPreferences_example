...
public class DefaultData {
    public static ArrayList<Country> getDefaultData(){
        ...
        country = new Country("Cuba", 11238317, 0.212, ContinentConst.NORTH_AMERICA);
        country.addInternetResources(
                "https://en.wikipedia.org/wiki/Cuba",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Coat_of_arms_of_Cuba.svg/2000px-Coat_of_arms_of_Cuba.svg.png",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Flag_of_Cuba.svg/2000px-Flag_of_Cuba.svg.png");
        countries.add(country);

        country = new Country("Aruba", 103400, 0.003, ContinentConst.SOUTH_AMERICA);
        country.addInternetResources(
                "https://en.wikipedia.org/wiki/Aruba",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Coat_of_arms_of_Aruba.svg/2000px-Coat_of_arms_of_Aruba.svg.png",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Flag_of_Aruba.svg/2000px-Flag_of_Aruba.svg.png");
        countries.add(country);

        country = new Country("Uganda", 37873253, 0.085, ContinentConst.AFRICA);
        country.addInternetResources(
                "https://en.wikipedia.org/wiki/Uganda",
                "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Coat_of_arms_of_the_Republic_of_Uganda.svg/2000px-Coat_of_arms_of_the_Republic_of_Uganda.svg.png",
